...
import { createWorkbenchLocale, type WebLocale } from "@adeptify/goalboard-app-workbench";
export { EN, LOCALE_COOKIE, WEB_LOCALES, LOCALE_SWITCH_STYLES, type WebLocale } from "@adeptify/goalboard-app-workbench";
