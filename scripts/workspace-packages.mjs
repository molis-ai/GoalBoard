...
export const WORKSPACE_PACKAGES = [
  entry("apps/desktop", "@adeptify/goalboard-app-desktop", "app", "@adeptify/goalboard-contracts/platform/app-host", ["goal-reorg-ap4", "goal-reorg-dv4"], "GoalBoard macOS product shell and native bridge composition root.", "Business facts, Module rules, or Runtime state.", ["desktop/", "src/desktop/"], { maturity: "partial", capabilities: ["desktop.shell.v1", "desktop.runtime-launch.v1", "desktop.advance-prompt.v1", "desktop.panels.v1", "desktop.capsule-shell.v1"], extraWorkspaceDependencies: ["@adeptify/goalboard-service-runtime-host", "@adeptify/goalboard-storage", "@adeptify/goalboard-plugin-feed", "@adeptify/goalboard-app-local-host"] }),
  entry("apps/workbench", "@adeptify/goalboard-app-workbench", "app", "@adeptify/goalboard-contracts/platform/app-host", ["goal-reorg-fd4", "goal-reorg-ap3", "goal-reorg-gw4", "goal-reorg-gw5", "goal-reorg-ex4"], "Local product UI composition root for the Workbench.", "Business Stores, Node-only implementations, or Tauri commands.", ["src/web/"], { maturity: "partial", capabilities: ["workbench.shell.v1", "workbench.ui-slots.v1", "workbench.feed-composition.v1", "workbench.goals-command-adapter.v1", "workbench.execution-validation-adapter.v1", "workbench.work-composition.v1", "workbench.goals-policy-composition.v1", "workbench.goals-safety-composition.v1", "workbench.goals-relation-composition.v1", "workbench.goals-tree-composition.v1", "workbench.goals-momentum-composition.v1", "workbench.goals-document-composition.v1", "workbench.goals-context-composition.v1", "workbench.goals-planning-composition.v1", "workbench.goals-status-composition.v1", "workbench.goals-factors-composition.v1", "workbench.goals-dialogs-composition.v1", "workbench.goals-document-routes.v1"], extraWorkspaceDependencies: ["@adeptify/goalboard-plugin-artifacts", "@adeptify/goalboard-plugin-goals", "@adeptify/goalboard-plugin-feed", "@adeptify/goalboard-plugin-work", "@adeptify/goalboard-ui-host", "@adeptify/goalboard-design-system", "@adeptify/goalboard-integration-rss", "@adeptify/goalboard-integration-gmail"] }),
  entry("apps/local-host", "@adeptify/goalboard-app-local-host", "app", "@adeptify/goalboard-contracts/platform/app-host", ["goal-reorg-ap2"], "The single local composition root for Modules, services, plugins, and storage.", "A second business coordinator or user-facing product shell.", ["src/web/server.ts", "src/cli/", "src/mcp/"], { maturity: "partial", extraDependencies: { "ws": "^8.21.3", "@adeptify/search-evidence-layer": "file:../../vendor/search-evidence-layer/adeptify-search-evidence-layer-0.4.1.tgz", "@adeptify/intelligence-client": "file:../../vendor/intelligence-client/adeptify-intelligence-client-0.2.2.tgz" }, capabilities: ["local-host.client.v1", "local-host.single-writer.v1"], extraWorkspaceDependencies: ["@adeptify/goalboard-app-cli", "@adeptify/goalboard-plugin-work", "@adeptify/goalboard-service-runtime-host", "@adeptify/goalboard-service-connector-host", "@adeptify/goalboard-integration-github", "@adeptify/goalboard-integration-gmail", "@adeptify/goalboard-integration-rss", "@adeptify/goalboard-integration-youtube", "@adeptify/goalboard-plugin-feed", "@adeptify/goalboard-module-projects", "@adeptify/goalboard-app-workbench", "@adeptify/goalboard-plugin-goals", "@adeptify/goalboard-storage", "@adeptify/goalboard-module-artifacts", "@adeptify/goalboard-module-evidence-verification", "@adeptify/goalboard-module-execution", "@adeptify/goalboard-module-governance-collaboration", "@adeptify/goalboard-module-feed", "@adeptify/goalboard-module-sources", "@adeptify/goalboard-module-signals", "@adeptify/goalboard-module-attention-resumption", "@adeptify/goalboard-service-listener-host", "@adeptify/goalboard-app-mcp", "@adeptify/goalboard-kernel", "@adeptify/goalboard-module-context-ledger", "@adeptify/goalboard-module-goals", "@adeptify/goalboard-module-private-work-context", "@adeptify/goalboard-plugin-artifacts", "@adeptify/goalboard-plugin-runtime", "@adeptify/goalboard-ui-host"] }),
...
entry("modules/context-ledger", "@adeptify/goalboard-module-context-ledger", "module", "@adeptify/goalboard-contracts/modules/context-ledger", ["goal-reorg-ar2"], "Object references, cross-owner relationships, publication, and materialization records.", "The referenced Goal, Artifact, Feed, or Session content.", ["src/v1/coordinator.ts", "src/feed/", "src/sessions/"], { maturity: "partial", capabilities: ["context.edges.v1"] }),
  ...
  entry("plugins/native/goals", "@adeptify/goalboard-plugin-goals", "native-plugin", "@adeptify/goalboard-contracts/platform/plugin", ["goal-f826dfb8-bf63-4e98-b6b7-57f6b4b7c3b8", "goal-reorg-gw4", "goal-reorg-gw5", "goal-reorg-ex4"], "Protected first-party Goals navigation, UI, commands, and composition.", "Goal facts, Stores, or another Plugin implementation.", ["src/web/render.ts"], { maturity: "partial", capabilities: ["goals.execution-validation-application.v1", "goals.policy-ui.v1", "goals.safety-ui.v1", "goals.relation-ui.v1", "goals.tree-ui.v1", "goals.momentum-ui.v1", "goals.document-ui.v1", "goals.context-ui.v1", "goals.planning-ui.v1", "goals.status-ui.v1", "goals.factors-ui.v1", "goals.dialogs-ui.v1", "goals.document-routes.v1"], extraWorkspaceDependencies: ["@adeptify/goalboard-module-evidence-verification", "@adeptify/goalboard-module-execution", "@adeptify/goalboard-module-goals"] }),
  entry("plugins/native/artifacts", "@adeptify/goalboard-plugin-artifacts", "native-plugin", "@adeptify/goalboard-contracts/platform/plugin", ["goal-reorg-ar3"], "Protected first-party Artifact browsing, embedding, and composition.", "Artifact facts, Stores, or producer/consumer implementations.", ["src/web/render.ts", "src/web/server.ts"], { maturity: "partial", capabilities: ["artifacts.project-reference.v1", "artifacts.browser.v1"] }),
  entry("plugins/native/feed", "@adeptify/goalboard-plugin-feed", "native-plugin", "@adeptify/goalboard-contracts/platform/plugin", ["goal-reorg-fd4"], "First-party Feed navigation, UI, disposition, and Module composition.", "Source/Signal/Feed/Attention facts or Provider implementations.", ["src/web/render.ts", "src/web/server.ts"], { maturity: "partial", extraDependencies: { "@adeptify/intelligence-client": "file:../../../vendor/intelligence-client/adeptify-intelligence-client-0.2.2.tgz",  "@adeptify/search-evidence-layer": "file:../../../vendor/search-evidence-layer/adeptify-search-evidence-layer-0.4.1.tgz", "marked": "^18.0.11", "sanitize-html": "^2.17.7" }, capabilities: ["feed.native-plugin.contract.v1", "feed.ui-contribution.v1", "feed.http-routes.v1"] }),
  ...
  entry("plugins/official-integrations/rss", "@adeptify/goalboard-integration-rss", "integration-plugin", "@adeptify/goalboard-contracts/platform/plugin", ["goal-reorg-fd3"], "Official catalog and custom RSS provider adapters.", "Source/Signal/Feed facts or a general-purpose HTTP platform.", ["src/feed/sources/"], { maturity: "partial", extraDependencies: { "@adeptify/search-evidence-layer": "file:../../../vendor/search-evidence-layer/adeptify-search-evidence-layer-0.4.1.tgz" }, capabilities: ["connector.rss.v1", "signal-adapter.rss.v1"], extraWorkspaceDependencies: ["@adeptify/goalboard-plugin-sdk"] }),
  ...
  entry("tooling/plugin-cli", "@adeptify/goalboard-plugin-cli", "tooling", "@adeptify/goalboard-contracts/platform/tooling", ["goal-reorg-dv3"], "Plugin creation, Manifest/Contract validation, local debugging, packaging, and signing workflow boundary.", "A fake runnable CLI before the SDK and lifecycle implementation exist.", [], { maturity: "partial", capabilities: ["plugin.manifest.validate.v1"], extraWorkspaceDependencies: ["@adeptify/goalboard-plugin-runtime"] }),
];
