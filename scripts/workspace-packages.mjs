...
export const WORKSPACE_PACKAGES = [
  ...
  entry("apps/local-host", "@adeptify/goalboard-app-local-host", "app", "@adeptify/goalboard-contracts/platform/app-host", ["goal-reorg-ap2"], "The single local composition root for Modules, services, plugins, and storage.", "A second business coordinator or user-facing product shell.", ["src/web/server.ts", "src/cli/", "src/mcp/"], { maturity: "partial", capabilities: ["local-host.client.v1", "local-host.single-writer.v1"], extraWorkspaceDependencies: ["@adeptify/goalboard-app-mcp", "@adeptify/goalboard-kernel", "@adeptify/goalboard-module-context-ledger", "@adeptify/goalboard-module-private-work-context", "@adeptify/goalboard-plugin-artifacts", "@adeptify/goalboard-plugin-runtime", "@adeptify/goalboard-ui-host"] }),
