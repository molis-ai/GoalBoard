...
export const WORKSPACE_PACKAGES = [
  ...
  entry("apps/local-host", "@adeptify/goalboard-app-local-host", "app", "@adeptify/goalboard-contracts/platform/app-host", ["goal-reorg-ap2"], "The single local composition root for Modules, services, plugins, and storage.", "A second business coordinator or user-facing product shell.", ["apps/desktop/launchers/web/server.ts", "src/cli/", "src/mcp/"], { maturity: "partial", extraDependencies: { "ws": "^8.21.3", "@adeptify/search-evidence-layer": "file:../../vendor/search-evidence-layer/adeptify-search-evidence-layer-0.4.1.tgz", "@adeptify/intelligence-client": "file:../../vendor/intelligence-client/adeptify-intelligence-client-0.2.2.tgz" }, capabilities: ["local-host.client.v1", "local-host.single-writer.v1"], extraWorkspaceDependencies: ["@adeptify/goalboard-app-cli", "@adeptify/goalboard-plugin-work", "@adeptify/goalboard-service-runtime-host", "@adeptify/goalboard-service-connector-host", "@adeptify/goalboard-integration-github", "@adeptify/goalboard-integration-gmail", "@adeptify/goalboard-integration-rss", "@adeptify/goalboard-integration-youtube", "@adeptify/goalboard-plugin-feed", "@adeptify/goalboard-module-projects", "@adeptify/goalboard-app-workbench", "@adeptify/goalboard-plugin-goals", "@adeptify/goalboard-storage", "@adeptify/goalboard-module-artifacts", "@adeptify/goalboard-module-evidence-verification", "@adeptify/goalboard-module-execution", "@adeptify/goalboard-module-governance-collaboration", "@adeptify/goalboard-module-feed", "@adeptify/goalboard-module-sources", "@adeptify/goalboard-module-signals", "@adeptify/goalboard-module-attention-resumption", "@adeptify/goalboard-service-listener-host", "@adeptify/goalboard-app-mcp", "@adeptify/goalboard-kernel", "@adeptify/goalboard-module-context-ledger", "@adeptify/goalboard-module-goals", "@adeptify/goalboard-module-private-work-context", "@adeptify/goalboard-plugin-artifacts", "@adeptify/goalboard-plugin-runtime", "@adeptify/goalboard-ui-host"] }),
