...
export const WORKSPACE_PACKAGES = [
  ...
  entry("apps/cli", "@adeptify/goalboard-app-cli", "app", "@adeptify/goalboard-contracts/platform/app-host", ["goal-reorg-dv1", "goal-reorg-gw4", "goal-reorg-ex4"], "Thin CLI protocol, argument, and presentation adapter.", "Business decisions, Module Stores, or duplicated application rules.", ["src/cli/"], { maturity: "partial", capabilities: ["cli.goals-command-adapter.v1"], extraWorkspaceDependencies: ["@adeptify/goalboard-plugin-goals"] }),
  entry("apps/mcp", "@adeptify/goalboard-app-mcp", "app", "@adeptify/goalboard-contracts/platform/app-host", ["goal-reorg-dv1", "goal-reorg-dv2", "goal-reorg-gw4", "goal-reorg-ex4"], "Thin MCP schema, audience, and capability adapter.", "Business rules, direct Store access, or Runtime Skill policy.", ["src/mcp/"], { maturity: "partial", capabilities: ["mcp.goals-command-adapter.v1"], extraWorkspaceDependencies: ["@adeptify/goalboard-plugin-goals"] }),
...
entry("modules/context-ledger", "@adeptify/goalboard-module-context-ledger", "module", "@adeptify/goalboard-contracts/modules/context-ledger", ["goal-reorg-ar2"], "Object references, cross-owner relationships, publication, and materialization records.", "The referenced Goal, Artifact, Feed, or Session content.", ["src/v1/coordinator.ts", "src/feed/", "src/sessions/"], { maturity: "partial", capabilities: ["context.edges.v1"] }),
  ...
  entry("plugins/native/goals", "@adeptify/goalboard-plugin-goals", "native-plugin", "@adeptify/goalboard-contracts/platform/plugin", ["goal-f826dfb8-bf63-4e98-b6b7-57f6b4b7c3b8", "goal-reorg-gw4", "goal-reorg-gw5", "goal-reorg-ex4"], "Protected first-party Goals navigation, UI, commands, and composition.", "Goal facts, Stores, or another Plugin implementation.", ["src/web/render.ts"], { maturity: "partial", capabilities: ["goals.event-application.v1", "goals.policy-ui.v1", "goals.safety-ui.v1", "goals.relation-ui.v1", "goals.tree-ui.v1", "goals.momentum-ui.v1", "goals.document-ui.v1", "goals.context-ui.v1", "goals.planning-ui.v1", "goals.status-ui.v1", "goals.factors-ui.v1", "goals.dialogs-ui.v1", "goals.document-routes.v1"], extraWorkspaceDependencies: ["@adeptify/goalboard-module-evidence-verification", "@adeptify/goalboard-module-execution", "@adeptify/goalboard-module-goals"] }),
