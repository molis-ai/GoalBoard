...
export const WORKSPACE_PACKAGES = [
  ...
  entry("packages/storage", "@adeptify/goalboard-storage", "foundation", "@adeptify/goalboard-contracts/platform/storage", ["goal-reorg-ap2"], "SQLite, filesystem, Blob, transaction, migration, and backup technical ports.", "The business meaning of Module schemas or cross-Module queries.", ["src/v1/store.ts", "src/feed/store.ts"], { maturity: "partial", extraDependencies: { "better-sqlite3": "12.8.0" } }),
