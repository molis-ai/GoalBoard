...
INSERT INTO "boards" VALUES('goalboard-v1-demo','让第一次使用 GoalBoard 的人顺利完成一次目标协作','V1','2026-09-10T07:03:28.489Z','2026-09-10T07:03:28.555Z');
...
INSERT INTO "events" VALUES(1,'4005bba2-9fb1-4282-af2b-25b83e4ee59d','goalboard-v1-demo','demo-user','board.created','board','goalboard-v1-demo','创建 GoalBoard 真相源','{"title":"让第一次使用 GoalBoard 的人顺利完成一次目标协作"}','2026-09-10T07:03:28.489Z');
...
INSERT INTO "events" VALUES(15,'0e3b4c7f-3fa4-4eeb-b361-1d26779657b1','goalboard-v1-demo','demo-user','relation.added','relation','relation-46303826-25b2-4b8e-ad5e-b76617d90fc9','共同组成第一次完整的 GoalBoard 使用体验','{"from_goal_id":"PLATFORM","to_goal_id":"V1","type":"part_of","reason":"共同组成第一次完整的 GoalBoard 使用体验"}','2026-09-10T07:03:28.510Z');
INSERT INTO "events" VALUES(16,'a8f67517-1803-41b7-b450-18b9353870d1','goalboard-v1-demo','demo-user','relation.added','relation','relation-d0cedc75-3cc4-4977-a253-247efa2b82fb','共同组成第一次完整的 GoalBoard 使用体验','{"from_goal_id":"WORKSPACE","to_goal_id":"V1","type":"part_of","reason":"共同组成第一次完整的 GoalBoard 使用体验"}','2026-09-10T07:03:28.512Z');
INSERT INTO "events" VALUES(17,'f6f131ad-8701-4d9e-80d0-83ef4a9b3ea3','goalboard-v1-demo','demo-user','relation.added','relation','relation-4814cf00-c15c-4d86-b625-15f7c60df9b7','共同组成第一次完整的 GoalBoard 使用体验','{"from_goal_id":"ADOPTION","to_goal_id":"V1","type":"part_of","reason":"共同组成第一次完整的 GoalBoard 使用体验"}','2026-09-10T07:03:28.513Z');
...
INSERT INTO "evidence" VALUES('evidence-3aaba898-2eb4-4565-acbb-13cccced105f','goalboard-v1-demo','CORE',1,'["CORE-C1"]','runtime-core','run-45ec1136-7bbf-4740-9e6b-1689e672c7af',NULL,'test','command://pnpm-test','unverified','不透明或外部 locator 已保留为 UNVERIFIED；GoalBoard 不会调用自定义协议','2026-09-10T07:03:28.545Z',NULL,NULL,NULL,'2026-09-10T07:03:28.545Z','passed',0);
...
INSERT INTO "goal_relations" VALUES('relation-46303826-25b2-4b8e-ad5e-b76617d90fc9','goalboard-v1-demo','PLATFORM','V1','part_of','active','共同组成第一次完整的 GoalBoard 使用体验','demo-user','2026-09-10T07:03:28.510Z',NULL);
INSERT INTO "goal_relations" VALUES('relation-d0cedc75-3cc4-4977-a253-247efa2b82fb','goalboard-v1-demo','WORKSPACE','V1','part_of','active','共同组成第一次完整的 GoalBoard 使用体验','demo-user','2026-09-10T07:03:28.512Z',NULL);
INSERT INTO "goal_relations" VALUES('relation-4814cf00-c15c-4d86-b625-15f7c60df9b7','goalboard-v1-demo','ADOPTION','V1','part_of','active','共同组成第一次完整的 GoalBoard 使用体验','demo-user','2026-09-10T07:03:28.513Z',NULL);
...
INSERT INTO "goals" VALUES('V1','goalboard-v1-demo','让第一次使用的人顺利完成一轮目标协作','用户能把一个模糊想法变成清楚的目标树，并知道下一步、阻塞和完成依据','AI 对话结束后容易丢失目标、决定和进度，新用户尤其难判断该从哪里继续','用户先在当前对话说明想做什么，Runtime 通过提问整理目标并请用户确认；确认后，当前或后续 Runtime 从可做项中选择工作，提交结果和证据，GoalBoard 持续保存共同进度。','[]','[]','[]','[]','[]',NULL,'accepted','closed_compound','valid','unmet',1,NULL,NULL,NULL,NULL,100,'demo-user','2026-09-10T07:03:28.489Z','2026-09-10T07:03:28.489Z','2026-09-10T07:03:28.489Z');
INSERT INTO "goals" VALUES('PLATFORM','goalboard-v1-demo','让项目事实成为不同 Runtime 的共同底座','不同 AI、会话和工具读取同一份 Goal、关系、决定、进度与完成依据','长程任务最容易在切换对话和 Runtime 后失去共同上下文','GoalBoard 保存项目事实；Runtime 只负责读取可做项、执行工作并提交结果，不在各自会话里维护另一套项目记忆。','[]','[]','[]','[]','[]',NULL,'accepted','closed_compound','valid','unmet',1,NULL,NULL,NULL,NULL,96,'demo-user','2026-09-10T07:03:28.490Z','2026-09-10T07:03:28.490Z','2026-09-10T07:03:28.490Z');
...
INSERT INTO "goals" VALUES('DESKTOP','goalboard-v1-demo','把 GoalBoard 作为不切窗口的主工作站','用户在桌面端同时看到 Goal、下一步、完成要求和强绑定的 Runtime','工作在 AI 对话里推进、状态在另一个页面查看，会增加切换成本并削弱人的掌控感','桌面端复用网页事实和 Runtime 能力，将全局控制放进 TitleBar，并为 List、Focus 与 Runtime 保留连续三栏。','[]','[]','[]','[]','[]',NULL,'accepted','closed_leaf','valid','unmet',1,NULL,NULL,NULL,NULL,74,'demo-user','2026-09-10T07:03:28.507Z','2026-09-10T07:03:28.507Z','2026-09-10T07:03:28.507Z');
INSERT INTO "goals" VALUES('RELEASE','goalboard-v1-demo','让新用户安装后知道下一步怎么开始','用户完成安装后知道如何启动页面、连接正在使用的 Runtime，以及为什么需要新开会话','安装成功但不知道服务是否常驻、工具何时生效或下一步说什么，仍然会被理解成产品不可用','安装只放置 GoalBoard 自己的程序，不偷偷修改项目或 Runtime；用户随后显式启用常驻服务、预览并确认 Runtime 接入，再在新会话中选择或创建项目开始使用。','[]','[]','[]','[]','[]',NULL,'draft','abstract','valid','unmet',1,NULL,NULL,NULL,NULL,60,NULL,NULL,'2026-09-10T07:03:28.508Z','2026-09-10T07:03:28.508Z');
...
INSERT INTO "goals" VALUES('DOCS','goalboard-v1-demo','让用户从 README 进入正确的使用方式','用户先理解长程任务为何会跑偏，再看到 GoalBoard 的闭环、桌面端和 Runtime 伴随方式','功能清单无法建立需求感，也无法解释 GoalBoard 与 Agent Orchestration 的边界','README 用痛点、核心思路和完整演示组织内容；截图来自 Mock 项目的真实网页与桌面页面。','[]','[]','[]','[]','[]',NULL,'accepted','closed_leaf','valid','unmet',1,NULL,NULL,NULL,NULL,56,'demo-user','2026-09-10T07:03:28.509Z','2026-09-10T07:03:28.509Z','2026-09-10T07:03:28.509Z');
...
INSERT INTO "risks" VALUES('RISK-FIRST-RESTART','goalboard-v1-demo','用户接入 Runtime 后没有新开会话，误以为安装失败','medium','用户看不到 GoalBoard 工具，无法开始第一次使用','["首次安装","Runtime 接入"]','用户继续使用接入前已经打开的会话','mitigate','','none','安装结果和接入预览都清楚说明新开会话的原因和下一步','产品体验','open',NULL,'2026-09-10T07:03:28.532Z','2026-09-10T07:03:28.532Z');
