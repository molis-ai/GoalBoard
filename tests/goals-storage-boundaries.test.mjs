...
test("production Store/import/Web boundaries reject restored Goal schema and coverage SQL", () => {
  for (const file of ["src/sdk-store.ts", "plugins/native/goals/src/board-v3-import.ts", "apps/local-host/src/board-v3-import.ts", "src/web/server.ts", "apps/local-host/src/web-request.ts"]) {
