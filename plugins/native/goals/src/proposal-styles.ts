...
export const GOALS_DECISION_COMMON_STYLES = `  .decision-record { min-width: 0; margin: 0; padding: 0; border: 1px solid var(--line-strong); border-radius: 5px; overflow: hidden; background: #fff; }
...
export const GOALS_PROPOSAL_STYLES = `  .goal-tree-proposal-summary { margin-top: 11px; padding: 11px 12px; border-left: 2px solid var(--blue); background: var(--blue-soft); display: grid; gap: 2px; }
