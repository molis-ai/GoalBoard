...
export const GOALS_DECISION_RESULTS_UI_CONTRIBUTION_ID = "io.goalboard.native.goals.decision-results";
...
export const goalsDecisionResultsUiContribution: UiContribution<GoalsDecisionResultsUiModel> = {
  descriptor: { contribution_id: GOALS_DECISION_RESULTS_UI_CONTRIBUTION_ID, plugin_id: "io.goalboard.native.goals", kind: "embedded", label: "Recent Goal decisions",
